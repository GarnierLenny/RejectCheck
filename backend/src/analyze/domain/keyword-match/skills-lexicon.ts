...
export const SKILLS_LEXICON: LexiconEntry[] = [
  ...
  { canonical: 'Objective-C', category: 'language', aliases: ['objc'] },
  {
    canonical: 'R',
    category: 'language',
    aliases: ['r programming', 'r language', 'rlang', 'rstudio', 'r studio'],
    matchCanonical: false,
  },
  ...
  { canonical: 'Kanban', category: 'practice', aliases: [] },
  {
    ...
    category: 'practice',
    aliases: ['micro services', 'microservice'],
  },
  ...
  },
  {
    ...
    category: 'practice',
    aliases: ['event driven', 'event-driven architecture'],
  },
  {
    canonical: 'OOP',
    category: 'practice',
  ...
  {
    canonical: 'Domain-Driven Design',
    category: 'practice',
  ...
  },
  {
    canonical: 'Analytics',
    category: 'tooling',
    aliases: ['google analytics', 'product analytics'],
  },
  ...
  // ── Product management ─────────────────────────────────────────────────
  {
    ...
    category: 'product',
    aliases: ['product roadmap', 'roadmap', 'roadmapping'],
  },
  {
  ...
  },
  {
    ...
    category: 'product',
    aliases: ['user story', 'user stories'],
  },
  {
  ...
  },
  {
    canonical: 'PRD',
    category: 'product',
    aliases: ['product requirements document', 'product spec'],
  },
  {
    canonical: 'MVP',
    category: 'product',
  ...
  },
  {
    ...
    category: 'product',
    aliases: ['go-to-market', 'go to market', 'gtm'],
  },
  {
  ...
  },
  {
    ...
    category: 'design',
    aliases: ['wireframe', 'wireframes', 'wireframing'],
  },
  {
    canonical: 'Prototyping',
    category: 'design',
    aliases: ['prototyping', 'rapid prototyping'],
  },
  {
    canonical: 'Design System',
    category: 'design',
    aliases: ['design system', 'design systems'],
  },
  {
    canonical: 'Usability Testing',
    category: 'design',
    aliases: ['usability testing', 'usability test'],
  },
  {
    canonical: 'Information Architecture',
    category: 'design',
    aliases: ['information architecture'],
  },
  {
    canonical: 'Interaction Design',
    category: 'design',
    aliases: ['interaction design'],
  },
  {
  ...
  },
  {
    ...
    category: 'design',
    aliases: ['journey mapping', 'customer journey', 'user journey'],
  },
  {
    canonical: 'User Personas',
    category: 'design',
    aliases: ['user persona', 'user personas', 'personas'],
  },
  ...
  },
  {
    canonical: 'PPC',
    category: 'marketing',
    aliases: ['pay per click', 'pay-per-click'],
  },
  {
  ...
  },
  {
    ...
    category: 'marketing',
    aliases: ['social media marketing', 'social media', 'smm'],
  },
  {
    canonical: 'Growth Marketing',
    category: 'marketing',
    aliases: ['growth marketing', 'growth hacking'],
  },
  {
    canonical: 'Demand Generation',
    category: 'marketing',
    aliases: ['demand generation', 'demand gen'],
  },
  {
    canonical: 'Lead Generation',
    category: 'marketing',
    aliases: ['lead generation', 'lead gen', 'leadgen'],
  },
  {
  ...
  { canonical: 'Copywriting', category: 'marketing', aliases: ['copywriter'] },
  {
    canonical: 'Branding',
    category: 'marketing',
    aliases: ['brand marketing', 'brand strategy'],
  },
  {
  ...
  },
  {
    ...
    category: 'marketing',
    aliases: ['paid media', 'paid search', 'paid social'],
  },
  {
  ...
  },
  {
    canonical: 'Meta Ads',
    category: 'marketing',
    aliases: ['meta ads', 'facebook ads'],
  },
  {
    canonical: 'LinkedIn Ads',
    category: 'marketing',
    aliases: ['linkedin ads'],
  },
  {
  ...
  { canonical: 'ROAS', category: 'marketing', aliases: ['return on ad spend'] },
  {
    canonical: 'CTR',
    category: 'marketing',
    aliases: ['click-through rate', 'click through rate'],
  },
  ...
  { canonical: 'CPM', category: 'marketing', aliases: ['cost per mille'] },
  {
    canonical: 'MQL',
    category: 'marketing',
    aliases: ['marketing qualified lead', 'mqls'],
  },
  ...
  {
    canonical: 'Sales Navigator',
    category: 'sales',
    aliases: ['linkedin sales navigator', 'sales navigator'],
  },
  ...
  { canonical: 'Prospecting', category: 'sales', aliases: [] },
  {
    ...
    category: 'sales',
    aliases: ['cold calling', 'cold outreach', 'cold email'],
  },
  {
    canonical: 'Pipeline Management',
    category: 'sales',
    aliases: ['pipeline management', 'sales pipeline'],
  },
  {
  ...
  },
  {
    canonical: 'Quota',
    category: 'sales',
    aliases: ['quota attainment', 'quota-carrying'],
  },
  {
    canonical: 'Sales Forecasting',
    category: 'sales',
    aliases: ['sales forecasting'],
  },
  ...
  { canonical: 'Looker', category: 'ops', aliases: [] },
  {
    ...
    category: 'ops',
    aliases: ['supply chain', 'supply chain management', 'scm'],
  },
  ...
  },
  {
    ...
    category: 'ops',
    aliases: ['process improvement', 'continuous improvement'],
  },
  { canonical: 'Lean', category: 'ops', aliases: ['lean manufacturing'] },
  {
    canonical: 'Six Sigma',
    category: 'ops',
    aliases: ['six sigma', 'lean six sigma'],
  },
  {
  ...
  { canonical: 'Budgeting', category: 'ops', aliases: ['budget management'] },
  {
    canonical: 'P&L',
    category: 'ops',
    aliases: ['profit and loss', 'p&l management'],
  },
  {
    canonical: 'SLA',
    category: 'ops',
  ...
  },
  {
    ...
    category: 'ops',
    aliases: ['demand forecasting', 'financial forecasting'],
  },
  {
