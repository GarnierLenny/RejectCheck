      ...
      <div className="bg-white border border-rc-border rounded-[32px] p-8 md:p-14 w-full max-w-[620px] shadow-[0_30px_70px_rgba(201,58,57,0.08)] relative overflow-hidden group">
        ...
        <div className="relative z-10 text-center">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-rc-red/5 border border-rc-red/10 mb-8">
            ...
            <span className="font-mono text-[10px] tracking-[0.2em] uppercase text-rc-red font-bold">{t.paywall.badge}</span>
          </div>

          <h2 className="text-[32px] md:text-[42px] font-bold text-rc-text mb-4 leading-[1.1] tracking-tight">
            {t.paywall.title} <span className="text-rc-red">{t.paywall.titleHighlight}</span>
          </h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-12 justify-center">
            ...
            >
              {t.paywall.getAccess} <ArrowRight className="ml-2 w-4 h-4 transition-transform group-hover:translate-x-1" />
            </Link>
            <Link
          ...
          <div className="max-w-[400px] mx-auto">
            <p className="font-mono text-[10px] uppercase tracking-widest text-rc-hint mb-4 font-bold">{t.paywall.waitlist.label}</p>
            {state === 'success' ? (
