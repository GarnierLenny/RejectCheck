  ...
  return (
    <div className="min-h-screen bg-rc-bg text-rc-text font-sans">
      ...
      <nav className="flex items-center justify-between px-5 py-4 md:px-[40px] border-b-[0.5px] border-rc-border bg-white/50 backdrop-blur-md sticky top-0 z-50">
        ...
        <Link href="/login" className="font-mono text-[11px] tracking-widest uppercase text-rc-hint hover:text-rc-text transition-colors no-underline flex items-center gap-2">
      ...
      <main className="max-w-[800px] mx-auto px-5 py-16 md:py-24">
        ...
        <div className="text-center mb-16">
          ...
          <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-4">Privacy Policy (GDPR)</h1>
        ...
        <section className="space-y-12">
          ...
          <div className="space-y-4">
            <h2 className="text-2xl font-bold flex items-center gap-3">
              <Eye className="w-6 h-6 text-rc-red" /> 1. Commitment to Privacy
            </h2>
          ...
          <div className="space-y-4">
            <h2 className="text-2xl font-bold flex items-center gap-3">
              <Database className="w-6 h-6 text-rc-red" /> 2. What Data We Collect
            </h2>
          ...
          <div className="space-y-4">
            <h2 className="text-2xl font-bold flex items-center gap-3">
              <Lock className="w-6 h-6 text-rc-red" /> 3. AI & Data Processing
            </h2>
            <p className="text-rc-muted leading-relaxed">
          ...
          <div className="space-y-4">
            <h2 className="text-2xl font-bold flex items-center gap-3">
              <Trash2 className="w-6 h-6 text-rc-red" /> 4. Right to Deletion
            </h2>
            <p className="text-rc-muted leading-relaxed">
        ...
        <footer className="mt-24 pt-8 border-t border-rc-border text-center">
          <Link href="/" className="font-mono text-[11px] tracking-widest uppercase text-rc-hint hover:text-rc-red transition-colors no-underline">
            Back to Home
          </Link>
        </footer>
      </main>
