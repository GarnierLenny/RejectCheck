...
const COPY: Record<Locale, Copy> = {
  en: {
    ...
    faqItems: [
      ...
      { question: 'Is this ATS checker free?', answer: 'Yes. The first analysis on RejectCheck is free, no signup required. You upload your CV and paste the target job description, and you get an ATS score with the exact missing keywords and their point values.' },
  ...
  fr: {
    ...
    faqItems: [
      ...
      { question: 'Ce checker ATS est-il gratuit ?', answer: 'Oui. La première analyse sur RejectCheck est gratuite, sans inscription. Tu déposes ton CV et tu colles l’offre visée, et tu obtiens un score ATS avec les mots-clés manquants exacts et leur poids en points.' },
