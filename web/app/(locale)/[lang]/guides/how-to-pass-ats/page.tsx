...
const COPY: Record<Locale, Copy> = {
  en: {
    ...
    s2List: [
      ...
      { pre: '- ', strong: 'Not', post: ' in white text or hidden fields, which modern ATS detect and penalize' },
    ],
    ...
    faqItems: [
      {
        ...
        answer:
          'Most medium-to-large companies do, especially in tech. A single posting can receive 200 to 1,000+ applications, and manual review at that volume is impossible. The ATS is a filter, not a choice.',
      },
      {
  ...
  fr: {
    ...
    s2List: [
      ...
      { pre: '- ', strong: 'Surtout pas', post: ' en texte blanc ou champs cachés, que les ATS modernes détectent et pénalisent' },
    ],
    ...
    faqItems: [
      {
        ...
        answer:
          'La plupart des moyennes et grandes entreprises, surtout dans la tech. Une seule annonce peut recevoir 200 à 1 000+ candidatures, et la lecture manuelle à ce volume est impossible. L’ATS est un filtre, pas un choix.',
      },
      {
