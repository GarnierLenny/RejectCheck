  ...
  fr: {
    ...
    faqItems: [
      ...
      },
      {
        ...
        answer:
          'Moins de 60 secondes. La revue est générée par un pipeline à double IA (GPT-4o et Claude) qui tournent en parallèle — chaque modèle audite une couche différente (récit, signal technique, cohérence, format), puis les sorties sont assemblées. La rapidité vient de la concurrence, pas d’un raccourci sur la profondeur.',
      },
      {
